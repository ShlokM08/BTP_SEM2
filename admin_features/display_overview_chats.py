...
def display_overview():
   import sys
   sys.path.append('E:/check/Stage_2_All_Data_Combined/admin_features')  # Add the directory path, not the file path
   import admin_dashboard_graphs
   admin_dashboard_graphs.main()
