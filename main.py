...
# from auth import check_user, get_user_name
# import os
# from pymongo import MongoClient
# import base64

# st.set_page_config(layout="centered", page_title="Login Screen")
...
# # Add custom styles with background image
...
#         st.session_state.client = MongoClient(MONGO_URI)
